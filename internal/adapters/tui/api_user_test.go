...
func TestApplyPlanUsage_DetectsAPIUser(t *testing.T) {
	...
	got := applyPlanUsageToMock(MockData{}, ports.PlanUsage{}, ports.ErrPlanUsageUnavailable)
	if !got.IsAPIUser {
...
func TestApplyPlanUsage_GenericErrorIsOffline(t *testing.T) {
	...
	got := applyPlanUsageToMock(MockData{}, ports.PlanUsage{}, errors.New("network unreachable"))
	if got.IsAPIUser {
...
func TestApplyPlanUsage_SubscriberSetsTier(t *testing.T) {
	...
	got := applyPlanUsageToMock(MockData{}, pu, nil)
